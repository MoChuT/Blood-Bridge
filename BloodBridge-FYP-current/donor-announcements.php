...
$announcements = read_records('announcements', [
    [
        'title' => 'MMU Blood Donation Drive',
        'details' => 'Main Hall, May 12-13, 2026. Bring identification and eat before donating.',
        'status' => 'Published',
    ],
    [
        'title' => 'O- Donor Request',
        'details' => 'O- stock is low. Eligible O- donors are encouraged to book early slots.',
        'status' => 'Priority',
    ],
    [
        'title' => 'Health Screening Reminder',
        'details' => 'Complete screening before appointment confirmation.',
        'status' => 'Notice',
    ],
]);
?>
