...
$announcements = read_records('announcements', [
    ['title' => 'MMU Blood Donation Drive', 'details' => 'Main Hall, May 12-13, 2026.', 'status' => 'Published'],
    ['title' => 'O- Donor Request', 'details' => 'Priority notice for eligible O- donors.', 'status' => 'Priority'],
]);
?>
<!doctype html>
<html lang="en">
