...
$inventoryUpdates = read_records('inventory_updates');
...
foreach ($inventoryUpdates as $update) {
    $totalBloodBags += (int)($update['quantity_update'] ?? 0);
}
  ...
  <form method="post" action="../actions.php" style="display:inline;">
    ...
    <main class="container">
      ...
      <section class="grid grid-3">
        <div class="metric"><span>Registered donors</span><strong><?= $totalDonors ?></strong></div>
        <div class="metric"><span>Appointments today</span><strong><?= $totalAppointments ?></strong></div>
        <div class="metric"><span>Blood bags ready</span><strong><?= $totalBloodBags ?></strong></div>
      </section>
